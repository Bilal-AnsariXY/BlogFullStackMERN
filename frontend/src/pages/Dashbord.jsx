...
export default function Dashboard() {
  ...
  if (!myPro) return <p className="text-center mt-10 text-gray-500">Loading profile...</p>;
  if (myPro.role !== "admin")
    return <p className="text-center mt-10 text-red-500">You are not the admin</p>;
    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <div className="flex-1 p-4 overflow-auto bg-white">
          ...
          {(component === "update blog" || component === "update") && (
            <Updateblog
              updateId={updateId}
          ...
          {component === "my blogs" && (
            <Myblogs updateId={updateId} setUpdateId={setUpdateId} myPro={myPro} setComponent={setComponent} />
          )}
        </div>
      </div>
    </div>
